...
englishLetter = {1:"AEIOULNSTR', 2:'DG', 3:'BCMP",
                4:"FHVWY", 5:"K" , 8:"JX", 10:"QZ"}
russianLetter = {1:"АВЕИНОРСТ", 2:"ДКЛМПУ", 3:"БГЁЬЯ",
...
if word[0].lower() in eng:
    summa = 0
    for letter in word:
        for key, value in englishLetter.items():
    ...
    if word[0].lower() in rus:
        ...
        for letter in word:
            ...
            for key, value in russianLetter.items():
                if letter.upper() in value:
                    summa += key
